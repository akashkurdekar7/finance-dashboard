...
const handleAddTxn = (e) => {
  ...
  return (
    <motion.div
      ...
      initial={{opacity: 0}}
      animate={{opacity: 1}}>
      {/* <header className="relative z-20 flex flex-col md:flex-row md:items-end justify-between gap-12 pb-8 border-b border-white/5"> */}
      {/* <header className="sticky top-0 z-[100] bg-slate-950/80 backdrop-blur-xl flex flex-col md:flex-row md:items-end justify-between gap-12 px-6 py-4 border-b border-white/5"> */}
      <header className="sticky top-0 z-[100]   flex flex-col md:flex-row md:items-end justify-between gap-12 ">
