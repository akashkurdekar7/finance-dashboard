    ...
    const analyzeData = () => {
        ...
        transactions.forEach(t => {
            if (t.type === 'expense') {
                ...
                dailyTransactions[bucket].sum += t.amount;
                dailyTransactions[bucket].count++;
            }
        });

        const topCategory = Object.entries(categories).sort((a, b) => b[1] - a[1])[0] || ["None", 0];

        const weekendAvg = dailyTransactions.weekend.count
            ? dailyTransactions.weekend.sum / dailyTransactions.weekend.count
            : 0;

        const weekdayAvg = dailyTransactions.weekday.count
            ? dailyTransactions.weekday.sum / dailyTransactions.weekday.count
            : 0;
        ...
        <div className="space-y-8">
            ...
            <div className="flex items-center gap-3">
                ...
                <div>
                    ...
                    <p className="text-xs text-slate-500">Automated financial intelligence</p>
                </div>
            </div>
            ...
            <div className="grid gap-4">
                ...
                <div className="p-6 rounded-xl border border-white/10 bg-white/5">
                    ...
                    <p className="text-sm text-slate-400">
                        You could save ~₹{(intel.topAmount * 0.15).toFixed(0)} monthly by reducing this category.
                    </p>
                </div>
                ...
                {intel.isDeficit && (
                    <div className="p-6 rounded-xl border border-red-500/20 bg-red-500/5">
                        <div className="flex items-center gap-2 text-red-400 mb-2">
                            ...
                            <span className="text-xs uppercase tracking-wide">Alert</span>
                        </div>
                        ...
                        <p className="text-sm text-red-300/70">
                            Overspent by ₹{intel.deficitAmount.toLocaleString()}
                        </p>
                    </div>
                )}
                ...
                <div className="p-6 rounded-xl border border-white/10 bg-white/5">
                    ...
                    <p className="text-sm text-slate-300">
                        {intel.isWeekendHeavy
                            ? "Weekend spending is significantly higher. Consider pre-setting budgets."
                            : "Your spending pattern is balanced across the week."}
                    </p>
                </div>
            </div>
