    ...
    <div className="flex flex-col md:flex-row items-center gap-6 bg-slate-900/40 p-4 rounded-[2.5rem] border border-white/5 backdrop-blur-xl self-start shadow-2xl">
      <div className="relative group w-full md:w-96">
        ...
        <input
          ...
          className="w-full bg-slate-950/40 border border-white/5 hover:border-white/10 rounded-2xl py-3.5 pl-14 pr-8 text-[10px] font-bold focus:ring-2 focus:ring-brand-primary outline-none text-slate-100 placeholder:text-slate-600 transition-all shadow-inner"
        />
      </div>
